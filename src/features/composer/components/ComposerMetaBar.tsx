    ...
    <div className="composer-bar">
      <div className="composer-meta">
        ...
        <div className="composer-select-wrap composer-select-wrap--model">
          ...
          {selectedServiceTier === "fast" && (
            <span
              ...
              role="status"
              aria-label={t("composer.fastModeEnabled")}
              title={t("composer.fastModeEnabled")}
            >
        ...
        <div className="composer-select-wrap">
          ...
          >
            <option value="read-only">{t("composer.agentAccessReadOnly")}</option>
            <option value="current">{t("composer.agentAccessOnRequest")}</option>
            <option value="full-access">{t("composer.agentAccessFullAccess")}</option>
          </select>
        </div>
      </div>
        ...
        <div
          ...
          data-tooltip={
            contextFreePercent === null
              ...
              : `${t("composer.contextFree")} ${Math.round(contextFreePercent)}%`
          }
          aria-label={
            contextFreePercent === null
              ? t("composer.contextFree")
